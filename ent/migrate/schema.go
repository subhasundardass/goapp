...
var (
	// AccountingsColumns holds the columns for the "accountings" table.
	AccountingsColumns = []*schema.Column{
	...
	// AccountingsTable holds the schema information for the "accountings" table.
	AccountingsTable = &schema.Table{
		Name:       "accountings",
		Columns:    AccountingsColumns,
		PrimaryKey: []*schema.Column{AccountingsColumns[0]},
	}
	...
	LedgersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{LedgersColumns[8], LedgersColumns[5]},
			},
		},
	}
