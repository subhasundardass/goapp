...
// Repo handles all database operations for the Settings module.
...
func (r *Repo) All(ctx context.Context) ([]*ent.Setting, error) {
	return r.db.Setting.Query().All(ctx)
}

func (r *Repo) Set(ctx context.Context, key, value string) error {
	return r.db.Setting.Update().
...
func (r *Repo) FindByID(ctx context.Context, id int) (any, error) {
	// TODO: return r.db.Settings.Get(ctx, id)
	return nil, nil
}

func (r *Repo) Create(ctx context.Context, name, description string) (any, error) {
	// TODO: return r.db.Settings.Create().SetName(name).SetDescription(description).Save(ctx)
	return nil, nil
}

func (r *Repo) Update(ctx context.Context, id int, name, description string) (any, error) {
	// TODO: return r.db.Settings.UpdateOneID(id).SetName(name).SetDescription(description).Save(ctx)
	return nil, nil
}

func (r *Repo) Delete(ctx context.Context, id int) error {
	// TODO: return r.db.Settings.DeleteOneID(id).Exec(ctx)
	return nil
}
...
func (r *Repo) SearchByName(ctx context.Context, params core.PaginationParams) ([]any, int, error) {
	...
	// q := r.db.Settings.Query()
	// if params.Search != "" {
	//     q = q.Where(settings.NameContainsFold(params.Search))
	// }
	return []any{}, 0, nil
}
